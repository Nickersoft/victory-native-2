...
const CartesianAxis = ({ tickCount = tickHelpers_1.DEFAULT_TICK_COUNT, xTicksNormalized, yTicksNormalized, labelPosition = "outset", labelOffset = { x: 2, y: 4 }, axisSide = { x: "bottom", y: "left" }, lineColor = "hsla(0, 0%, 0%, 0.25)", lineWidth = react_native_1.StyleSheet.hairlineWidth, labelColor = "#000000", formatYLabel = (label) => String(label), formatXLabel = (label) => String(label), yScale, xScale, font, isNumericalData = false, ix = [], }) => {
    ...
    const yAxisNodes = yTicksNormalized.map((tick) => {
        ...
        return ((0, jsx_runtime_1.jsxs)(react_1.default.Fragment, { children: [(0, jsx_runtime_1.jsx)(react_native_skia_1.Line, { p1: (0, react_native_skia_1.vec)(xScale(x1), yScale(tick)), p2: (0, react_native_skia_1.vec)(xScale(x2), yScale(tick)), color: gridYLineColor, strokeWidth: gridYLineWidth }), font
                    ? canFitLabelContent && ((0, jsx_runtime_1.jsx)(react_native_skia_1.Text, { color: typeof labelColor === "string" ? labelColor : labelColor.y, text: contentY, font: font, y: labelY, x: labelX }))
                    : null] }, `y-tick-${tick}`));
    });
    const xAxisNodes = xTicksNormalized.map((tick) => {
        ...
        return ((0, jsx_runtime_1.jsxs)(react_1.default.Fragment, { children: [(0, jsx_runtime_1.jsx)(react_native_skia_1.Line, { p1: (0, react_native_skia_1.vec)(xScale(tick), yScale(y2)), p2: (0, react_native_skia_1.vec)(xScale(tick), yScale(y1)), color: gridXLineColor, strokeWidth: gridXLineWidth }), font && labelWidth && canFitLabelContent ? ((0, jsx_runtime_1.jsx)(react_native_skia_1.Text, { color: typeof labelColor === "string" ? labelColor : labelColor.x, text: contentX, font: font, y: labelY, x: labelX })) : null] }, `x-tick-${tick}`));
    });
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [xTicks > 0 ? xAxisNodes : null, yTicks > 0 ? yAxisNodes : null, (0, jsx_runtime_1.jsx)(react_native_skia_1.Path, { path: boundingFrame, strokeWidth: gridFrameLineWidth, style: "stroke", color: gridFrameLineColor })] }));
};
