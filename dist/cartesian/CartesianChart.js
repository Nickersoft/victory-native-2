...
function CartesianChart({ data, xKey, yKeys, padding, domainPadding, children, renderOutside = () => null, axisOptions, domain, chartPressState, onChartBoundsChange, gestureLongPressDelay = 100, }) {
    ...
    // Body of the chart.
    const body = ((0, jsx_runtime_1.jsxs)(react_native_skia_1.Canvas, { style: { flex: 1 }, onLayout: onLayout, children: [hasMeasuredLayoutSize && ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: axisOptions ? ((0, jsx_runtime_1.jsx)(CartesianAxis_1.CartesianAxis, Object.assign({}, axisOptions, { xScale,
                    yScale,
                    isNumericalData,
                    xTicksNormalized,
                    yTicksNormalized,
                    ix: _tData.ix }))) : null })), (0, jsx_runtime_1.jsx)(CartesianChartContext_1.CartesianChartProvider, { yScale: yScale, xScale: xScale, children: (0, jsx_runtime_1.jsx)(react_native_skia_1.Group, { clip: clipRect, children: hasMeasuredLayoutSize && children(renderArg) }) }), hasMeasuredLayoutSize && (renderOutside === null || renderOutside === void 0 ? void 0 : renderOutside(renderArg))] }));
    // Conditionally wrap the body in gesture handler based on activePressSharedValue
    return chartPressState ? ((0, jsx_runtime_1.jsx)(react_native_gesture_handler_1.GestureHandlerRootView, { style: { flex: 1 }, children: (0, jsx_runtime_1.jsx)(react_native_gesture_handler_1.GestureDetector, { gesture: panGesture, children: body }) })) : (body);
}
