...
const PieChart = (props) => {
    ...
    return data.map((slice, index) => {
        return ((0, jsx_runtime_1.jsx)(PieSliceContext_1.PieSliceProvider, { slice: slice, children: children ? children({ slice }) : (0, jsx_runtime_1.jsx)(PieSlice_1.PieSlice, {}) }, index));
    });
};
